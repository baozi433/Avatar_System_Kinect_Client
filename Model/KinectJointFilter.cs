...
namespace KinectV2OSC
{
    ...
    public class KinectJointFilter
    {
        ...
        // float fSmoothing = 0.25f, float fCorrection = 0.25f, float fPrediction = 0.25f, float fJitterRadius = 0.08f, float fMaxDeviationRadius = 0.03f
        public void Init(float fSmoothing = 0.25f, float fCorrection = 0.25f, float fPrediction = 0.25f, float fJitterRadius = 0.08f, float fMaxDeviationRadius = 0.03f)
        {
        ...
        public void Reset(float fSmoothing = 0.25f, float fCorrection = 0.25f, float fPrediction = 0.25f, float fJitterRadius = 0.08f, float fMaxDeviationRadius = 0.03f)
        {
