namespace KinectV2OSC
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public MainWindow()    //constructor
        {
            ...
            //
            this.kinectJointFilter = new KinectJointFilter();
        }

        private void InitKinect()
        {
            Size displaySize = new Size(0, 0);   //struct Size(double, double)
        ...
        private void InitNetwork()
        {
            ...
            var ipAddress = cameraConfig.serveraddress;
            var port = cameraConfig.serverport;
            this.bodySender = new BodySender(ipAddress, port.ToString());
        }
            ...
            try
            {
                ...
                if (frame != null)
                {
                    using (frame)
                    {
                        ...
                        CameraSpacePoint[] m_pFilteredJoints = this.kinectJointFilter.GetFilteredJoints();

                        this.kinectCanvas.Draw(this.bodies, m_pFilteredJoints);
                        this.bodySender.Send(this.bodies, m_pFilteredJoints, cameraConfig.index);
